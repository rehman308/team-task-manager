...
import { fetchProjectTitle } from '../api/projects';
...
export default function ProjectDetail() {
  ...
  const { data: projectTitle, isLoading: isTitleLoading } = useQuery({
    queryKey: ['projectTitle', projectId],
    queryFn: () => fetchProjectTitle(projectId),
    enabled: !!projectId,
  });
  ...
  return (
    <>
      <TitleBar title={isTitleLoading ? 'Project' : projectTitle.title} />
